...
from experiment_builders.joint_vae_builder import JointVAEWORLDExperimentBuilder, JointVAERawExperimentBuilder
...
if args.dataset == 'VCCWORLD2016':
    ...
    joint_vae_experiment = JointVAEWORLDExperimentBuilder(network_model=joint_vae_model,
    ...
    quantised_input_joint_vae_model = QuantisedInputModuleWrapper(args.num_input_quantization_channels, joint_vae_model)
    
    joint_vae_experiment = JointVAERawExperimentBuilder(network_model=quantised_input_joint_vae_model,
                                        experiment_name=args.experiment_name,
                                        num_epochs=args.num_epochs,
                                        weight_decay_coefficient=args.weight_decay_coefficient,
                                        learning_rate=args.learning_rate,
...
experiment_metrics, test_metrics = joint_vae_experiment.run_experiment()